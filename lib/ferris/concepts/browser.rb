module Ferris
  module Browser
    class << self
      ...
      def local(**args)
        Watir::Browser.new(:chrome, service_log_path: '/tmp/chromedirver.log', options: Selenium::WebDriver::Chrome::Options.new(args: map_switches(args), prefs: map_prefs(args)))
      end
